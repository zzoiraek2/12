...
| FOBLGATE_TRANSFER_REVIEW_COMPLETED | 거래진행중 | 거래소 이체확인증 검토 완료 |
...
| STEP2 | 원화 입금 확인과 USDT 수령 확인 | USDT 수령 확인(니모닉 열람) | 원화 입금 확인 | 니모닉 열람 시 거래완료 |
...
| 니모닉 열람 | STEP2 | 원화 입금 확인 및 거래소 검토 완료 | 니모닉 복호화, 거래완료 |
...
| 니모닉 열람 | 열람 기간, PIN 검증, 접근 로그 | 시스템 | 기간 만료 후 차단 |
...
| 열람 시점 | STEP2에서 원화 입금 확인과 거래소 검토 완료 후 |
